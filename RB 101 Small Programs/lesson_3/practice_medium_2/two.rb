#Same as one, but in method form. Predict how object will change. 
...
NOTICE: THIS WORKS THE SAME IN THE FIRST PROBLEM
=end
...
NOTICE: THESE OUTERS ARE NOT THE SAME VARIABLES AS THOSE OUTSIDE, RUBY IS SIMPLY RE-USING THE OBJECTS, AS THESE NEW VARIABLES HAVE SAME VALUES
=end
...
NOTICE: RUBY IS RE-USING OBJECTS THAT HAVE THE SAME VALUES..
=end
